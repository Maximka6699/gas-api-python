...
def add_users(db: Session = Depends(get_db)):
    users_data = [
        {"username": "admin1", "email": "admin1@example.com", "password": "hashed_password", "role": "admin"},
        {"username": "admin2", "email": "admin2@example.com", "password": "hashed_password", "role": "admin"},
        {"username": "user1", "email": "user1@example.com", "password": "hashed_password", "role": "user"},
        {"username": "user2", "email": "user2@example.com", "password": "hashed_password", "role": "user"},
        {"username": "user3", "email": "user3@example.com", "password": "hashed_password", "role": "user"},
    ]
...
def add_gases(db: Session = Depends(get_db)):
    for i in range(5):
...
def add_fdus(db: Session = Depends(get_db)):
...
def add_fuels(db: Session = Depends(get_db)):
